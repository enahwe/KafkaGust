...
* Each file suffixed by `-keys.txt` contains a list of keys that it's possible to use as Kafka keys to load-balance the messages to the partitions (see the ***msgKeyDef*** argument) 
